...
./configure CXXFLAGS="-Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize -Wl,-hugetlbfs-align -funroll-loops -finline-functions $extracflags -march=armv8.2-a+fp16fml+crypto -mtune=cortex-a55" CFLAGS="-finline-functions -Wl,-hugetlbfs-align -march=armv8.2-a+fp16fml+crypto -mtune=cortex-a55 -Rpass-missed=loop-vectorize -Rpass-analysis=loop-vectorize $extracflags -mllvm -enable-loop-distribute" CXX=clang++ CC=clang LDFLAGS="-v -flto -Wl,-hugetlbfs-align"
